...
rejected:
  - candidate: cache_block_uniformity
    ...
    explanation: This is a mandatory system-wide constraint rather than an implementation-selected parameter.
  ...
  - candidate: cache_block_range_properties
    ...
    explanation: These are properties of cache blocks, not independent parameters.
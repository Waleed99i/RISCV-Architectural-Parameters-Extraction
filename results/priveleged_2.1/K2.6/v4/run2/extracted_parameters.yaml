...
rejected:
  - candidate: csr_address_space
    ...
    explanation: The size of the CSR encoding space is fixed by the ISA specification.
  ...
  - candidate: csr_accessibility_encoding
    ...
    explanation: The accessibility encoding is prescribed by the architecture and is not implementation-selectable.
  ...
  - candidate: csr_read_write_indicator
    ...
    explanation: The read/write versus read-only encoding is fixed by the RISC-V architecture.
  ...
  - candidate: csr_privilege_level_encoding
    ...
    explanation: The privilege-level encoding is architecturally defined and is not configurable by implementations.
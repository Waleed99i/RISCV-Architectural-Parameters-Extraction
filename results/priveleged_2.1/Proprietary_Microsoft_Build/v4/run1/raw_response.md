...
rejected:
  - candidate: CSR_ENCODING_SPACE
    ...
    explanation: The CSR encoding space is architecturally fixed and not implementation-selected.
  ...
  - candidate: CSR_ACCESSIBILITY_ENCODING
    ...
    explanation: Accessibility encoding is defined by the ISA and not an implementation choice.

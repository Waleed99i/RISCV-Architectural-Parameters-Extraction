...
rejected:
  - candidate: cache_block_uniformity
    ...
    explanation: This specifies a requirement on implementations rather than an independent architectural parameter.
  ...
  - candidate: cache_block_range_properties
    ...
    explanation: These define cache block characteristics rather than selectable parameters.
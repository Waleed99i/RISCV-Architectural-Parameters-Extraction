parameters:
  ...
  - name: cache_organization
    ...
    description: The implementation-defined organization of a cache.
    type: string
    constraints:
      - implementation-specific
      - discoverable
  ...
  - name: cache_block_size
    ...
    description: The implementation-defined size of a cache block.
    type: integer
    constraints:
      - implementation-specific
      - discoverable
...
rejected:
  - candidate: cache_block_uniformity
    ...
    explanation: The statement specifies a mandatory architectural constraint rather than an implementation-selectable parameter.
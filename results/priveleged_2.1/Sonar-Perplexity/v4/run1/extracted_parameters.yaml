...
rejected:
  - candidate: csr_accessibility_encoding
    ...
    explanation: The snippet describes a conventional address mapping but does not state an implementation-configurable architectural parameter.
  ...
  - candidate: csr[11:0] encoding space
    ...
    explanation: The CSR encoding width and available address space are fixed by the ISA.
  ...
  - candidate: csr[11:8] accessibility encoding
    ...
    explanation: The mapping of CSR address bits to accessibility is architecturally defined.
  ...
  - candidate: csr[11:10] read/write or read-only encoding
    ...
    explanation: The read/write and read-only encoding is fixed by the architecture.

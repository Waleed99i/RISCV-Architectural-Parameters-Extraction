...
rejected:
  - candidate: csr_address_space
    ...
    explanation: The 12-bit CSR encoding space is fixed by the ISA specification.
  ...
  - candidate: csr_accessibility_encoding
    ...
    explanation: The accessibility encoding is architecturally defined and is not implementation-configurable.
  ...
  - candidate: csr_read_write_indicator
    ...
    explanation: The read/write versus read-only encoding is fixed by the ISA.
  ...
  - candidate: csr_privilege_level_encoding
    ...
    explanation: The privilege-level encoding is specified by the architecture and is not implementation-defined.